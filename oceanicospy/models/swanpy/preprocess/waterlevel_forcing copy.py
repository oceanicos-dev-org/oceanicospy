...
class WaterLevelForcing():
    ...
    def _match_wl_to_bathy(self):
        ...
        water_level[bathymetry_grid>=0]=float(self.dataset_filtered['depth[m]'][0])
        return water_level
    ...
    def _UHSLC_csv_to_ascii(self,UHSLC_filename,ascii_filename,detrend_wl=False):
        ...
        self.dataset = self.UHSLCDownloader_obj.clean_data(f'{self.init.dict_folders["input"]}domain_0{self.domain_number}/{UHSLC_filename}')

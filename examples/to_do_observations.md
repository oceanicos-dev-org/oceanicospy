...
- AWAC
  ...
  - To check the way how the direction is computed. Send to Juandi once everything is completed
- Weather stations: standardize the dataframes

  - same names across the weather stations implies knowing properly all the column names across the methods.
